...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { ativo: @atividade.ativo, categoria_id: @atividade.categoria_id, nome: @atividade.nome } }, as: :json
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { ativo: @atividade.ativo, categoria_id: @atividade.categoria_id, nome: @atividade.nome } }, as: :json
    assert_response 200
  end
